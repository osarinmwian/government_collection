...
namespace GovernmentCollections.Service.Services.Interswitch;
...
public interface IInterswitchGovernmentCollectionsService
{
    ...
    Task<InterswitchCustomerValidationResponse> ValidateCustomersAsync(InterswitchCustomerValidationRequest request);
